...
module Renum
  module EnumeratedValueTypeFactory
    ...
    def self.setup_for_definition_in_block klass
      klass.class_eval do
    ...
    def self.teardown_from_definition_in_block klass
      class << klass
